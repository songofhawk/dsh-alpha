...
@media(min-width:761px){.alpha-turn-controls{gap:8px;font-size:13px}.alpha-turn-label{font-size:13px}.alpha-turn-controls>select,.alpha-turn-settings-trigger{height:32px;padding:0 10px;font-size:13px}.alpha-turn-settings-panel{bottom:40px;width:min(320px,calc(100vw - 24px));max-height:calc(100dvh - 24px);overflow-y:auto;gap:12px;padding:16px;border-radius:14px}.alpha-turn-settings-panel>header strong{font-size:16px}.alpha-turn-settings-panel>header>div>button{height:32px;font-size:12px}.alpha-turn-settings-panel>header>div>button:last-child{width:32px}.alpha-turn-settings-refresh{padding:0 9px;font-size:12px}.alpha-turn-settings-hint{font-size:12px;line-height:1.5}.alpha-turn-settings-panel>label{gap:6px;font-size:12px}.alpha-turn-settings-panel>label select,.alpha-turn-settings-panel>label input{height:40px;padding:0 10px;font-size:14px}}
...
.alpha-inventory-loading{grid-column:1/-1;display:grid;place-content:center;justify-items:center;gap:12px;min-height:240px;color:#87867f;font-size:12px}.alpha-inventory-spinner{width:28px;height:28px;border:2px solid #e8e6dc;border-top-color:#c96442;border-radius:50%;animation:alpha-inventory-spin .72s linear infinite}@keyframes alpha-inventory-spin{to{transform:rotate(360deg)}}
...
.alpha-inventory-loading{color:var(--dsw-alias-label-tertiary)}.alpha-inventory-spinner{border-color:var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-brand-primary)}@media(prefers-reduced-motion:reduce){.alpha-inventory-spinner{animation:none}}
